    ...
    function() {
        var e = function(e) {
            ...
            function n() {
                ...
                }, new t(0, 17514381, 0, 0).open("GET", "/data.unity3d"), new t(17514381, 17514402, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new t(17514402, 17520199, 0, 0).open("GET", "/preserved_derived_types.xml"), new t(17520199, 19340847, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new t(19340847, 20215819, 0, 0).open("GET", "/Resources/unity_default_resources"), new t(20215819, 20243444, 0, 0).open("GET", "/Managed/mono/2.0/machine.config"), Module.addRunDependency("datafile_webgl.data"), Module.preloadResults || (Module.preloadResults = {}), Module.preloadResults[i] = {
                    fromCache: !1
                }, d ? (n(d), d = null) : l = n
            }
            var o;
